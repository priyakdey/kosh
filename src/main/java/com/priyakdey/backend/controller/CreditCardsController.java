...
public class CreditCardsController {
    ...
    @GetMapping
    public ResponseEntity<CreditCardsResponse> getCreditCards(Principal principal) {
        // holder name can be pulled from the logged-in user.
        // same case for the associated family of the logged-in user
